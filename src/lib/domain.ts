...
export const navGroups = [
  ["İş", ["tasks", "todo", "tools", "meetings", "marketing"]],
  ["CRM", ["crm", "calls", "map"]],
...
export const errorLabels: Record<string, string> = {
  ...
  CALL_PHONE_REQUIRED: "Zəng üçün müəssisənin telefon nömrəsi lazımdır.",
  CALL_QUEUE_UNAVAILABLE: "Bu qutu artıq zəng növbəsində deyil. Məlumatı yeniləyin.",
