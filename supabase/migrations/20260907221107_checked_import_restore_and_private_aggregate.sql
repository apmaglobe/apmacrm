...
alter function public.monthly_portfolio(uuid) set schema private;
create function public.monthly_portfolio(org uuid) returns jsonb language sql security invoker set search_path='' as $$select private.monthly_portfolio(org);$$;
